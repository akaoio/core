...
- For example: "I need help with hardener work" → Use `shield`
...
const coreAwareness = new CoreTechAwareness('shield');
...
// Announce globally
broadcastGlobal('shield agent online and ready');
